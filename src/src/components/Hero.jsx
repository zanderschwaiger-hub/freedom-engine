  ...
  return (
    <section ref={ref} style={{
      ...
      <div style={{
        ...
        background: `
          radial-gradient(ellipse at 72% 18%, rgba(203,213,225,0.55) 0%, transparent 52%),
          radial-gradient(ellipse at 12% 82%, rgba(15,23,42,0.07) 0%, transparent 46%)
        `
      }} />
      <div style={{
        position: 'absolute', inset: 0, pointerEvents: 'none',
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: '900px' }}>
        ...
        <div className="fade-up" style={{
          ...
          background: 'linear-gradient(90deg, var(--accent) 0%, rgba(15,23,42,0.08) 50%, transparent 100%)'
        }} />
