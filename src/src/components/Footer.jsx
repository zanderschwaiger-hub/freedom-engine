    ...
    <>
      ...
      <section ref={ref} style={{
        ...
        <div style={{
          ...
          background: 'radial-gradient(ellipse at 50% 50%, rgba(15,23,42,0.07) 0%, transparent 65%)'
        }} />
      ...
      <footer style={{
        ...
        <div style={{
          ...
          color: 'rgba(15,23,42,0.28)', textTransform: 'uppercase'
        }}>
          Digital safety through technical discipline.
        </div>
        <div style={{
          fontFamily: "'DM Mono', monospace",
          fontSize: '10px', color: 'rgba(15,23,42,0.2)',
          display: 'flex', gap: '16px', alignItems: 'center'
        }}>
          <span>© {new Date().getFullYear()} Freedom Engine</span>
          <a href="/privacy" style={{ color: 'rgba(15,23,42,0.3)', textDecoration: 'none' }}>Privacy</a>
          <a href="/terms" style={{ color: 'rgba(15,23,42,0.3)', textDecoration: 'none' }}>Terms</a>
        </div>
      </footer>
    </>
  )
