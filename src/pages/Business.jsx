...
export default function Business() {
  ...
  const field = {
    ...
    background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(200,169,110,0.18)',
  ...
  return (
    <div style={{ background: 'var(--navy)', color: 'var(--white)', minHeight: '100vh' }}>
      ...
      <header style={{
        ...
        alignItems: 'center', borderBottom: '1px solid rgba(200,169,110,0.07)'
      }}>
        <Link to="/" style={{
      ...
      <section style={{ padding: `0 ${pad} clamp(80px, 12vw, 140px)`, maxWidth: '560px', margin: '0 auto' }}>
        <div style={{
          ...
          border: '1px solid rgba(200,169,110,0.14)', borderRadius: '2px'
        }}>
          {status === 'done' ? (
        ...
        {/* Fine print */}
        <p style={{
          fontSize: '11px', fontWeight: 300, color: 'rgba(240,238,234,0.45)',
